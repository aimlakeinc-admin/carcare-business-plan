  ...
  return (
    <div className="min-h-[80vh] w-full flex items-center justify-center bg-gradient-to-br from-blue-900 via-blue-700 to-purple-700 text-white p-8 rounded-lg">
      <div className="text-center max-w-4xl">
        ...
        <p className="text-base mb-8 text-blue-300">Revolutionizing the CAD $511B North American automotive services market with CareChart AI, CarCare Wallet, and comprehensive EV & fleet solutions</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4 mb-12">
            <div className="group bg-gradient-to-br from-white/10 to-cyan-500/20 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:border-cyan-400/50 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/20">
              ...
              <p className="text-2xl font-bold text-white group-hover:text-cyan-300 transition-colors">CAD $511B</p>
            ...
            <div className="group bg-gradient-to-br from-white/10 to-green-500/20 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:border-green-400/50 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-green-500/20">
              ...
              <p className="text-2xl font-bold text-green-300 group-hover:text-green-200 transition-colors">CAD $6.71M</p>
              <p className="text-xs text-blue-300">Break-even by Year 2</p>
            </div>
            <div className="group bg-gradient-to-br from-white/10 to-emerald-500/20 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:border-emerald-400/50 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-emerald-500/20">
              <p className="text-sm text-blue-200 mb-1">Year 5 Revenue</p>
              <p className="text-2xl font-bold text-emerald-300 group-hover:text-emerald-200 transition-colors">CAD $104.4M</p>
              <p className="text-xs text-blue-300">24% net margin</p>
            </div>
            <div className="group bg-gradient-to-br from-white/10 to-purple-500/20 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:border-purple-400/50 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/20">
              ...
              <p className="text-2xl font-bold text-white group-hover:text-purple-300 transition-colors">60K</p>
              <p className="text-xs text-blue-300">By Year 3 (2028)</p>
            </div>
            <div className="group bg-gradient-to-br from-white/10 to-yellow-500/20 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:border-yellow-400/50 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-yellow-500/20">
              ...
              <p className="text-2xl font-bold text-green-300 group-hover:text-yellow-300 transition-colors">CAD $25.1M</p>
              <p className="text-xs text-blue-300">24% net margin</p>
            </div>
            <div className="group bg-gradient-to-br from-white/10 to-pink-500/20 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:border-pink-400/50 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-pink-500/20">
              <p className="text-sm text-blue-200 mb-1">Seed Funding (1 year)</p>
              <p className="text-2xl font-bold text-white group-hover:text-pink-300 transition-colors">CAD $2.5M</p>
        ...
        <div className="space-y-2 text-sm">
          ...
          <p>📞 +1 (437) 973-1676</p>
          <p>🌐 <a href="https://carcare24x7.com" target="_blank" rel="noopener noreferrer" className="text-blue-300 hover:text-blue-100 underline">https://carcare24x7.com</a></p>
        </div>
