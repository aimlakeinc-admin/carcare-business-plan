      ...
      <div className="bg-gray-50 rounded-lg p-6 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="font-semibold text-blue-600"><a href="https://carcare24x7.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">https://carcare24x7.com</a></p>
          </div>
        </div>
      </div>
    </div>
