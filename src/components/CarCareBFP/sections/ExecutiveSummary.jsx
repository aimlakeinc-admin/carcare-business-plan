    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-gradient-to-br from-green-50 to-green-100 border-l-4 border-green-500 p-6 rounded-lg shadow">
          ...
          <p className="text-3xl font-bold text-green-600 mb-2">CAD $475B</p>
          <p className="text-sm text-gray-700">North American Market</p>
          <p className="text-xs text-gray-600 mt-2">2024: CAD $475B → 2032: CAD $700-750B at 6% CAGR</p>
        </div>
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 border-l-4 border-blue-500 p-6 rounded-lg shadow">
          ...
          <p className="text-3xl font-bold text-blue-600 mb-2">CAD $38.6M</p>
          <p className="text-sm text-gray-700">By Year 3 (2028)</p>
          <p className="text-xs text-gray-600 mt-2">CAD $1.6M → CAD $11.5M → CAD $38.6M with break-even by Year 3</p>
        </div>
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 border-l-4 border-purple-500 p-6 rounded-lg shadow">
          ...
          <p className="text-3xl font-bold text-purple-600 mb-2">500K</p>
          <p className="text-sm text-gray-700">Users by 2027</p>
          <p className="text-xs text-gray-600 mt-2">5K → 50K → 500K across 3-phase rollout</p>
        </div>
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 border-l-4 border-orange-500 p-6 rounded-lg shadow">
          <h3 className="font-bold text-orange-800 mb-2 text-lg">Seed Funding</h3>
          <p className="text-3xl font-bold text-orange-600 mb-2">CAD $2.7M</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-start">
                <ChevronRight className="w-4 h-4 mr-2 flex-shrink-0 mt-0.5" />
                <span>5,000 users, 200 garages</span>
              </li>
              <li className="flex items-start">
                <ChevronRight className="w-4 h-4 mr-2 flex-shrink-0 mt-0.5" />
                <span>$1.2M revenue target</span>
              </li>
            </ul>
          </div>
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-start">
                <ChevronRight className="w-4 h-4 mr-2 flex-shrink-0 mt-0.5" />
                <span>50,000 users, fintech integration</span>
              </li>
              <li className="flex items-start">
                <ChevronRight className="w-4 h-4 mr-2 flex-shrink-0 mt-0.5" />
                <span>$8.5M revenue target</span>
              </li>
            </ul>
          </div>
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-start">
                <ChevronRight className="w-4 h-4 mr-2 flex-shrink-0 mt-0.5" />
                <span>500,000 users, EV & fleet modules</span>
              </li>
              <li className="flex items-start">
                <ChevronRight className="w-4 h-4 mr-2 flex-shrink-0 mt-0.5" />
                <span>$28.5M revenue target</span>
              </li>
            </ul>
          </div>
        </div>
