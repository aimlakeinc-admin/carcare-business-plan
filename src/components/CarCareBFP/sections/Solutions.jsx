    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-8 rounded-xl shadow-lg">
        ...
        <p className="text-lg text-gray-700 italic leading-relaxed">
          "To revolutionize the automotive services industry by creating the first unified digital marketplace that connects 26+ million Canadian vehicle owners with 15,000+ certified garages. We're transforming the $350 billion North American automotive services market through AI-powered predictive maintenance, transparent pricing, fintech integration, and real-time service tracking - making vehicle maintenance effortless, transparent, and rewarding for all stakeholders."
        </p>
      </div>
      ...
      <div className="bg-white border-2 border-gray-200 rounded-xl p-8 shadow-lg">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg mb-6">
          <p className="text-sm text-gray-700">
            <strong>Market Opportunity:</strong> Addressing the $350 billion North American automotive services market with 70% of vehicle owners reporting challenges finding reliable, affordable service providers. Our platform transforms the fragmented automotive service industry into a connected, intelligent ecosystem.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-start">
                <CheckCircle className="w-4 h-4 mr-2 flex-shrink-0 mt-0.5" />
                <span>$350B North American market opportunity</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-4 h-4 mr-2 flex-shrink-0 mt-0.5" />
