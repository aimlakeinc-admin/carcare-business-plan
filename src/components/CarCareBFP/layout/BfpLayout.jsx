          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-8 text-white">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
              <div className="bg-white bg-opacity-20 rounded p-3">
                ...
                <p className="text-2xl font-bold">CAD $475B</p>
              </div>
              <div className="bg-white bg-opacity-20 rounded p-3">
                <p className="text-sm text-blue-100">Year 5 Revenue</p>
                <p className="text-2xl font-bold">CAD $16.2M</p>
              </div>
              <div className="bg-white bg-opacity-20 rounded p-3">
                <p className="text-sm text-blue-100">Target Users</p>
                <p className="text-2xl font-bold">500K</p>
              </div>
              <div className="bg-white bg-opacity-20 rounded p-3">
                <p className="text-sm text-blue-100">Seed Funding</p>
                <p className="text-2xl font-bold">CAD $2.7M</p>
              </div>
            </div>
          </div>
        </div>
